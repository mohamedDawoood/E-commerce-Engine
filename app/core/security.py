...
def authinticate_user ( username , password , db : db_dependency):
...
SECRET_KEY = "VFAke6MjGigaQVE4WyzuuXs4z2LzLhfxrWcpTrwAG-Y" 
ALGORITHM = "HS256"
...
def get_current_user( db: db_dependency ,token: str = Depends(oauth2_scheme)):
    credentials_exception = HTTPException(
        ...
        detail="تعذر التحقق من الهوية (التوكن غير صالح)",
